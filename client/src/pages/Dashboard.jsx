  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      try {
        ...
        toast.error("Failed to load dashboard data."); // Added error notification
    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-slate-500 mt-1">Monitor milk collection statistics.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-5">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <p className="text-slate-500 text-sm">Milk Collection</p>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <h2 className="text-3xl font-bold text-emerald-600 mt-2">{loading ? "..." : dailyActiveCustomers}</h2>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <p className="text-slate-500 text-sm">Registered Customers</p>

          <h2 className="text-3xl font-bold text-indigo-600 mt-2">{loading ? "..." : totalRegisteredCustomers}</h2>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-5">
          ...
          <p className="text-slate-500 text-sm mb-3">Milk Types</p>
          ...
          <table className="w-full text-left text-sm">
            ...
            <thead className="bg-emerald-600 text-white">
              ...
              <tr>
                ...
                <th className="px-5 py-4 whitespace-nowrap hidden sm:table-cell">Phone</th>

                <th className="px-5 py-4 whitespace-nowrap hidden md:table-cell">Address</th>

                <th className="px-5 py-4 whitespace-nowrap">Milk Type</th>
            ...
            <tbody>
              ...
              {loading ? (
                ...
                customers.slice(0, 5).map((customer, index) => (
                  ...
                  <tr key={customer._id} className="border-b hover:bg-slate-50">

                    <td className="px-5 py-4 font-semibold text-slate-600">{index + 1}</td>

                    <td className="px-5 py-4 font-medium">{customer.name}</td>

                    <td className="px-5 py-4 hidden sm:table-cell">{customer.phone}</td>

                    <td className="px-5 py-4 hidden md:table-cell">{customer.address}</td>

                    <td className="px-5 py-4">{customer.milkType}</td>
